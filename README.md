...
$${\color{slateblue} \textbf Personalmente \space creo \space que \space la \space materia \space fue \space llevadera, \space las \space actividades \space siguieron \space un \space orden \space lógico \space en \space base \space a \space lo \space esperado.}$$
